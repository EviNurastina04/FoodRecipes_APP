...
public class CategoriesFragmentDirections {
  ...
  @NonNull
  public static ActionCategoriesFragmentToFilterFragment actionCategoriesFragmentToFilterFragment(
      @NonNull FilterQuery Filter) {
    return new ActionCategoriesFragmentToFilterFragment(Filter);
  }

  public static class ActionCategoriesFragmentToFilterFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionCategoriesFragmentToFilterFragment(@NonNull FilterQuery Filter) {
      if (Filter == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionCategoriesFragmentToFilterFragment setFilter(@NonNull FilterQuery Filter) {
      if (Filter == null) {
        throw new IllegalArgumentException("Argument \"Filter\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("Filter", Filter);
    ...
    public int getActionId() {
      return R.id.action_categoriesFragment_to_filterFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionCategoriesFragmentToFilterFragment that = (ActionCategoriesFragmentToFilterFragment) object;
    ...
    public String toString() {
      return "ActionCategoriesFragmentToFilterFragment(actionId=" + getActionId() + "){"
          + "Filter=" + getFilter()
          + "}";
    }
  }
