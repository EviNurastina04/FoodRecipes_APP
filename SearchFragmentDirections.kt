...
public class SearchFragmentDirections {
  ...
  @NonNull
  public static ActionSearchFragmentToRecipeFragment actionSearchFragmentToRecipeFragment() {
    return new ActionSearchFragmentToRecipeFragment();
  }

  public static class ActionSearchFragmentToRecipeFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    private ActionSearchFragmentToRecipeFragment() {
    }

    @NonNull
    @SuppressWarnings("unchecked")
    public ActionSearchFragmentToRecipeFragment setRecipeID(@NonNull String RecipeID) {
      if (RecipeID == null) {
    ...
    public int getActionId() {
      return R.id.action_searchFragment_to_recipeFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionSearchFragmentToRecipeFragment that = (ActionSearchFragmentToRecipeFragment) object;
    ...
    public String toString() {
      return "ActionSearchFragmentToRecipeFragment(actionId=" + getActionId() + "){"
