...
public class IngredientFragmentDirections {
  private IngredientFragmentDirections() {
  }

  @NonNull
  public static ActionIngrediantFragmentToFilterFragment actionIngrediantFragmentToFilterFragment(
      @NonNull FilterQuery Filter) {
    return new ActionIngrediantFragmentToFilterFragment(Filter);
  }

  public static class ActionIngrediantFragmentToFilterFragment implements NavDirections {
    private final HashMap arguments = new HashMap();

    @SuppressWarnings("unchecked")
    private ActionIngrediantFragmentToFilterFragment(@NonNull FilterQuery Filter) {
      if (Filter == null) {
    ...
    @NonNull
    @SuppressWarnings("unchecked")
    public ActionIngrediantFragmentToFilterFragment setFilter(@NonNull FilterQuery Filter) {
      if (Filter == null) {
        throw new IllegalArgumentException("Argument \"Filter\" is marked as non-null but was passed a null value.");
      }
      this.arguments.put("Filter", Filter);
    ...
    public int getActionId() {
      return R.id.action_ingrediantFragment_to_filterFragment;
    }
    ...
    public boolean equals(Object object) {
      ...
      ActionIngrediantFragmentToFilterFragment that = (ActionIngrediantFragmentToFilterFragment) object;
    ...
    public String toString() {
      return "ActionIngrediantFragmentToFilterFragment(actionId=" + getActionId() + "){"
          + "Filter=" + getFilter()
          + "}";
    }
  }
